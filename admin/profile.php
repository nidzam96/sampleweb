							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3 col-md-offset-1">
										<div class="navbar-default" style="height: 250px">
											<div>
												<img src="../images/Sky.png" alt="x de lg" class="image">
											</div>
										...
										<div class="box">
											<form action="#" method="post" enctype="multipart/form-data" id="edit-profile">
												...
												<div class="col-md-6 col-md-offset-5">
													<div class="row">
														<button type="submit" name="update" class="btn btn-md">Update</button>
													</div>
												</div>
